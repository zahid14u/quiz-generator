        ...
        <main className="flex-1 px-4 sm:px-8 py-8 max-w-5xl w-full mx-auto">
          ...
          <div className="flex items-center justify-between flex-wrap gap-3 mb-8">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">
                Here's your quiz activity at a glance.
              </p>
            </div>
            <span
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-5">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-purple-700 text-xs mt-1 leading-relaxed">
                        True/False, Fill in Blanks, Short Answer, 30 questions
                        per quiz, and unlimited daily quizzes.
                      </p>
                      <Link
                        href="/pricing"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-green-700 text-xs mt-1 leading-relaxed">
                        Full access — all question types, 30 questions per quiz,
                        unlimited daily generation.
                      </p>
                      <Link
                        href="/generate"
                        className="inline-flex items-center gap-1 mt-3 text-xs font-semibold text-green-700 hover:text-green-900"
                      >
                        Start generating →
                      </Link>
                    </div>
              ...
              {/* Device Sessions */}
              {user && <DeviceSessions userId={user.id} />}
            </div>
          </div>
        </main>
      </div>
